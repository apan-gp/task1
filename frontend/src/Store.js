/** Getting (way "from store") is done on save, by callback, and passed to components via props.
 * It is to use existing React's technology to make page auto-update.
 */
class Store {
  constructor() {
